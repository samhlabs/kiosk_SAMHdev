...
direct_commands = ['kwebhelper.py','omxplayergui.py','kwebhelper_set.py','omxplayer','gksudo','xterm','/media/PiShare/Git/kiosk_SAMHdev/startOMX.sh','/media/PiShare/Git/kiosk_SAMHdev/startCCOMX.sh','/media/PiShare/Git/kiosk_SAMHdev/stopOMX.sh','/media/PiShare/Git/kiosk_SAMHdev/volumeUp.sh','/media/PiShare/Git/kiosk_SAMHdev/volumeDown.sh']
